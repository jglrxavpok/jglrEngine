...
public class Input
{
	...
	private static int								  mdwheel				= 0;
	private static ArrayList<Integer>				   keysJustPressed		= new ArrayList<Integer>();
	private static ArrayList<Integer>				   buttonsJustPressed	 = new ArrayList<Integer>();
	private static ArrayList<Character>				 charactersJustPressed  = new ArrayList<Character>();

	private static ArrayList<Integer>				   keysJustReleased	   = new ArrayList<Integer>();
	private static ArrayList<Integer>				   buttonsJustReleased	= new ArrayList<Integer>();
	private static ArrayList<Character>				 charactersJustReleased = new ArrayList<Character>();

	private static HashMapWithDefault<Integer, Boolean> keys				   = new HashMapWithDefault<Integer, Boolean>();
	private static HashMapWithDefault<Integer, Boolean> buttons				= new HashMapWithDefault<Integer, Boolean>();
	private static HashMapWithDefault<Integer, Long>	keyTimes			   = new HashMapWithDefault<Integer, Long>();
	private static ArrayList<Character>				 charactersPressed	  = new ArrayList<Character>();
	static
	{
		keys.setDefault(false);
		buttons.setDefault(false);
		keyTimes.setDefault(-1L);
	}
	...
	public static void pollEvents()
	{
		...
		charactersJustPressed.clear();
		keysJustReleased.clear();
		buttonsJustReleased.clear();
		charactersJustReleased.clear();
		while(Keyboard.next())
		{
			...
			keys.put(key, state);
			keyTimes.put(key, Keyboard.getEventNanoseconds());
			charactersPressed.add(c);
			if(state)
			{
				keysJustPressed.add(key);
				charactersJustPressed.add(c);
			}
			else
			{
				keysJustReleased.add(key);
				charactersJustReleased.add(c);
			}
		}
		...
		while(Mouse.next())
		{
			...
			int edx = Mouse.getEventDX();
			int edy = Mouse.getEventDY();
	...
	public static long getNanoTimePressed(int key)
	{
		return keyTimes.get(key);
	}
	...
	public static ArrayList<Character> getJustPressedCharacters()
	{
		return (ArrayList<Character>)charactersJustPressed.clone();
	}

	@SuppressWarnings("unchecked")
	public static ArrayList<Character> getJustReleasedCharacters()
	{
		return (ArrayList<Character>)charactersJustReleased.clone();
	}

	public static boolean charPressed(char character)
	{
		return charactersPressed.contains(character);
	}

	public static boolean charJustReleased(char character)
	{
		return charactersJustReleased.contains(character);
	}

	public static boolean charJustPressed(char character)
	{
		return charactersJustPressed.contains(character);
	}
	...
	public static void lockCursor(boolean show)
	{
		Mouse.setGrabbed(show);
	}

	public static boolean isMouseCursorLocked()
	{
