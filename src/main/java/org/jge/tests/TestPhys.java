...
public class TestPhys
{
	...
	{
		BoundingSphere sphere1 = new BoundingSphere(new Vector3(0,0,0),1);
		BoundingSphere sphere2 = new BoundingSphere(new Vector3(0,3,0),1);
		BoundingSphere sphere3 = new BoundingSphere(new Vector3(0,0,2),1);
		BoundingSphere sphere4 = new BoundingSphere(new Vector3(1,0,0),1);
		...
		AABB aabb1 = new AABB(new Vector3(0,0,0),new Vector3(1,1,1));
		AABB aabb2 = new AABB(new Vector3(1,1,1),new Vector3(2,2,2));
		AABB aabb3 = new AABB(new Vector3(1,0,0),new Vector3(2,1,1));
		AABB aabb4 = new AABB(new Vector3(0,0,-2),new Vector3(1,1,-1));
		AABB aabb5 = new AABB(new Vector3(0,0.5,0),new Vector3(1,1.5,1));
